...
public final class ServiceExceptionMessages {
    ...
    public static final String BAD_SORTING_TYPE="Bad sorting type";
    ...
    public static final String PARAMS_NOT_FOUND="Objects with these parameters not found";
    public static final String NO_OBJ_FOUND="No objects found";
